...
// Might be unneeded I don't know how package imports work
...
public class BetterPPSwerveControllerCommand extends CommandBase {
  ...
  private final BetterSwerveKinematics kinematics;
  ...
  /**
   * Constructs a new BetterPPSwerveControllerCommand that when executed will follow the provided
   ...
   */
  public BetterPPSwerveControllerCommand(PathPlannerTrajectory trajectory,
  ...
  public BetterPPSwerveControllerCommand(PathPlannerTrajectory trajectory,
    ...
    this(trajectory, poseSupplier, xController, yController, rotationController,
   ...
   */
  public BetterPPSwerveControllerCommand(PathPlannerTrajectory trajectory,
      Supplier<Pose2d> poseSupplier, BetterSwerveKinematics kinematics, PIDController xController,
      PIDController yController, PIDController rotationController,
      Consumer<BetterSwerveModuleState[]> outputModuleStates, boolean useAllianceColor,
      Subsystem... requirements) {
    this.trajectory = trajectory;
    this.poseSupplier = poseSupplier;
  ...
  public BetterPPSwerveControllerCommand(PathPlannerTrajectory trajectory,
      Supplier<Pose2d> poseSupplier, BetterSwerveKinematics kinematics, PIDController xController,
      PIDController yController, PIDController rotationController,
      Consumer<BetterSwerveModuleState[]> outputModuleStates, Subsystem... requirements) {
    this(trajectory, poseSupplier, kinematics, xController, yController, rotationController,
  ...
  public void execute() {
    ...
    if (logError != null) {
      logError.accept(currentPose.getTranslation().minus(desiredState.poseMeters.getTranslation()),
  ...
  private static void defaultLogError(Translation2d translationError, Rotation2d rotationError) {
    SmartDashboard.putNumber("BetterPPSwerveControllerCommand/xErrorMeters",
        translationError.getX());
    SmartDashboard.putNumber("BetterPPSwerveControllerCommand/yErrorMeters",
        translationError.getY());
    SmartDashboard.putNumber("BetterPPSwerveControllerCommand/rotationErrorDegrees",
   ...
   *        active path. This will be called whenever a BetterPPSwerveControllerCommand starts
  ...
  public static void setLoggingCallbacks(Consumer<PathPlannerTrajectory> logActiveTrajectory,
    ...
    BetterPPSwerveControllerCommand.logActiveTrajectory = logActiveTrajectory;
    BetterPPSwerveControllerCommand.logTargetPose = logTargetPose;
    BetterPPSwerveControllerCommand.logSetpoint = logSetpoint;
    BetterPPSwerveControllerCommand.logError = logError;
  }
}
