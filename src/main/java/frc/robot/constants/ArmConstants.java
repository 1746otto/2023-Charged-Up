...
public final class ArmConstants {
  ...
  public static final double kArmRestPos = 0.0; // 0.5
  public static final double kArmIntakeAndScorePos = -18640.0; // CANCoder: 0.9065 human player pos:
                                                               // 0.5634
  // TODO: change cube intake pos
  // TODO: change positions constants to match cancoder.
  public static final double kArmConeIntakePos = -18640.0; // 0.7521
