...
public class ShootCommand extends SequentialCommandGroup {
  public ShootCommand(ArmPositionSubsystem armPositionSubsystem,
    ...
    addCommands(new ArmRequestSelectorCommand(armPositionSubsystem, ArmConstants.kShootPosition),
        new WaitCommand(0.25), new ArmRollerShootCommand(armRollersSubsystem).withTimeout(0.5),
