...
public class Indexersubsystem extends SubsystemBase {
    ...
    public Indexersubsystem() {
        ...
        Motor1 = new CANSparkMax(IndexerConstants.kIndexerMotor2, MotorType.kBrushless);
        Motor2 = new CANSparkMax(IndexerConstants.kIndexerMotor3, MotorType.kBrushless);
