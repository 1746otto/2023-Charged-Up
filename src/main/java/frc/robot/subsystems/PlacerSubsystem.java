...
public class PlacerSubsystem extends SubsystemBase {
    ...
    public PlacerSubsystem() {
        plungerPiston = new Solenoid(PlacerConstants.kModID, PneumaticsModuleType.REVPH, PlacerConstants.kPlungerChannel);
        clamperPiston = new Solenoid(PlacerConstants.kModID, PneumaticsModuleType.REVPH, PlacerConstants.kClamperChannel);
    }
